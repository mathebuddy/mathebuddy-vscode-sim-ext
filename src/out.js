...
(function dartProgram() {
  ...
  var A = {
      ...
      Primitives_functionNoSuchMethod(
        ...
        if (namedArguments != null && namedArguments.__js_helper$_length !== 0)
          namedArguments.forEach$1(
            0,
            new A.Primitives_functionNoSuchMethod_closure(
              t1,
              namedArgumentList,
              $arguments
            )
      ...
      Primitives_applyFunction($function, positionalArguments, namedArguments) {
        var argumentCount,
          jsStub,
          t1 =
            namedArguments == null || namedArguments.__js_helper$_length === 0;
        if (t1) {
        ...
        return A.Primitives__generalApplyFunction(
          $function,
          positionalArguments,
          namedArguments
        );
      ...
      Primitives__generalApplyFunction(
        ...
        if (argumentCount < requiredParameterCount)
          return A.Primitives_functionNoSuchMethod(
            $function,
            positionalArguments,
            namedArguments
          );
        ...
        if (t1) {
          if (
            namedArguments != null &&
            namedArguments.__js_helper$_length !== 0
          )
            return A.Primitives_functionNoSuchMethod(
              $function,
              positionalArguments,
        ...
        if (Array.isArray(defaultValues)) {
          ...
          } else $arguments = positionalArguments;
          ...
          if (namedArguments == null)
            for (
              ...
              _i < keys.length;
              keys.length === t1 ||
                (0, A.throwConcurrentModificationError)(keys),
                ++_i
            ) {
            ...
            for (
              ...
              if (namedArguments.containsKey$1(key)) {
                ++used;
                B.JSArray_methods.add$1(
                  $arguments,
                  namedArguments.$index(0, key)
                );
              } else {
      ...
      wrapException(ex) {
        var wrapper, t1;
        if (ex == null) ex = new A.NullThrownError();
        wrapper = new Error();
      ...
      objectHashCode(object) {
        ...
        else return A.Primitives_objectHashCode(object);
      },
      Closure_fromTearOff(parameters) {
        ...
        t1.toString;
        $prototype = isStatic
          ? Object.create(new A.StaticClosure().constructor.prototype)
          : Object.create(new A.BoundClosure(null, null).constructor.prototype);
      ...
      Closure_cspForwardInterceptedCall(
        ...
        switch (needsDirectAccess ? -1 : arity) {
          case 0:
            throw A.wrapException(
              new A.RuntimeError("Intercepted function with no arguments.")
            );
          case 1:
      ...
      BoundClosure_evalRecipe(closure, recipe) {
        return A._Universe_evalInEnvironment(
          init.typeUniverse,
          A.instanceType(closure._receiver),
          recipe
        );
      },
      ...
      BoundClosure__computeFieldNamed(fieldName) {
        ...
        throw A.wrapException(
          A.ArgumentError$("Field name " + fieldName + " not found.")
        );
      },
      ...
      Primitives_functionNoSuchMethod_closure:
        function Primitives_functionNoSuchMethod_closure(t0, t1, t2) {
          this._box_0 = t0;
      ...
      Rti__getQuestionFromStar(universe, rti) {
        ...
        return question == null
          ? (rti._precomputed1 = A._Universe__lookupQuestionRti(
              universe,
              rti._primary,
              true
            ))
      ...
      Rti__getFutureFromFutureOr(universe, rti) {
        ...
        return future == null
          ? (rti._precomputed1 = A._Universe__lookupInterfaceRti(
              universe,
              "Future",
              [rti._primary]
            ))
      ...
      _installSpecializedIsTest(object) {
        ...
        if (unstarred === type$.int) isFn = A._isInt;
        else if (unstarred === type$.double || unstarred === type$.num)
          isFn = A._isNum;
        else if (unstarred === type$.String) isFn = A._isString;
        else isFn = unstarred === type$.bool ? A._isBool : null;
      ...
      _installSpecializedAsCheck(object) {
        ...
        if (t1) asFn = A._asTop;
        else if (testRti === type$.Object) asFn = A._asObject;
        else {
            ...
            if (!(testRti === type$.legacy_Never))
              if (kind !== 7)
                if (!(kind === 6 && A._nullIs(testRti._primary)))
                  t1 =
                    (kind === 8 && A._nullIs(testRti._primary)) ||
                    testRti === type$.Null ||
                    testRti === type$.JSNull;
                else t1 = true;
              else t1 = true;
      ...
      _TypeError__TypeError$forType(object, type) {
        return new A._TypeError(
          "TypeError: " + A._Error_compose(object, null, type)
        );
      },
      _isObject(object) {
        return object != null;
      ...
      _functionRtiToString(functionType, genericContext, bounds) {
        ...
        if (bounds != null) {
          ...
          for (
            ...
            t4 = t3 - 1 - i;
            if (!(t4 >= 0)) return A.ioore(genericContext, t4);
            ...
            if (!t3)
              typeParametersText +=
                " extends " + A._rtiToString(boundRti, genericContext);
          }
          typeParametersText += ">";
        } else {
          typeParametersText = "";
        ...
        for (
          ...
          argumentsText +=
            sep + A._rtiToString(requiredPositional[i], genericContext);
        if (optionalPositionalLength > 0) {
          argumentsText += sep + "[";
          for (sep = "", i = 0; i < optionalPositionalLength; ++i, sep = _s2_)
            argumentsText +=
              sep + A._rtiToString(optionalPositional[i], genericContext);
          argumentsText += "]";
        }
        if (namedLength > 0) {
          argumentsText += sep + "{";
          for (sep = "", i = 0; i < namedLength; i += 3, sep = _s2_) {
            ...
            argumentsText +=
              A._rtiToString(named[i + 2], genericContext) + " " + named[i];
          }
          argumentsText += "}";
        }
      ...
      _rtiToString(rti, genericContext) {
        ...
        if (kind === 7) {
          ...
          return (
            (argumentKind === 12 || argumentKind === 13 ? "(" + s + ")" : s) +
            "?"
          );
        }
        if (kind === 8)
          return (
            "FutureOr<" + A._rtiToString(rti._primary, genericContext) + ">"
          );
        if (kind === 9) {
        ...
        if (kind === 14) {
          ...
          t1 = t2 - 1 - t1;
          if (!(t1 >= 0 && t1 < t2)) return A.ioore(genericContext, t1);
      ...
      _Universe_eval(universe, recipe, normalize) {
        ...
        if (probe != null) return probe;
        rti = A._Parser_parse(
          A._Parser_create(universe, null, recipe, normalize)
        );
        t1.set(recipe, rti);
        return rti;
      },
      _Universe_evalInEnvironment(universe, environment, recipe) {
        ...
        if (probe != null) return probe;
        rti = A._Parser_parse(
          A._Parser_create(universe, environment, recipe, true)
        );
      ...
      _Universe__createFutureOrRti(universe, baseType, key, normalize) {
        ...
        if (normalize) {
          ...
          if (t2 || baseType === type$.Object) return baseType;
            ...
            return A._Universe__lookupInterfaceRti(universe, "Future", [
              baseType,
            ]);
      ...
      _Universe__lookupBindingRti(universe, base, $arguments) {
        ...
        key =
          ...
          (";<" + A._Universe__canonicalRecipeJoin(newArguments) + ">");
        probe = universe.eC.get(key);
        if (probe != null) return probe;
        rti = new A.Rti(null, null);
        rti._kind = 10;
      ...
      _Universe__lookupFunctionRti(universe, returnType, parameters) {
        ...
        if (namedLength > 0) {
          sep = requiredPositionalLength > 0 ? "," : "";
          recipe +=
            sep + "{" + A._Universe__canonicalRecipeJoinNamed(named) + "}";
        }
        key = s + (recipe + ")");
        probe = universe.eC.get(key);
        if (probe != null) return probe;
      ...
      _Universe__lookupGenericFunctionRti(
        ...
        var t1,
          ...
          probe = universe.eC.get(key);
        if (probe != null) return probe;
        t1 = A._Universe__createGenericFunctionRti(
          universe,
          baseFunctionType,
          bounds,
          key,
        ...
        for (t2 = source.length, i = 0; i < t2; ) {
          ...
          if (ch >= 48 && ch <= 57)
            ...
            switch (ch) {
              ...
              case 94:
                t1.push(
                  A._Universe__lookupGenericFunctionParameterRti(
                    parser.u,
                    t1.pop()
                  )
                );
              ...
              case 42:
                ...
                t1.push(
                  A._Universe__lookupStarRti(
                    t3,
                    A._Parser_toType(t3, parser.e, t1.pop()),
                    parser.n
                  )
                );
                break;
          ...
          if (recipe == null)
            A.throwExpression(
              'No "' +
                string +
                '" in "' +
                A.Rti__getCanonicalRecipe(environment) +
                '"'
            );
      ...
      _Parser_handleArguments(parser, stack) {
        ...
        switch (head) {
          case -3:
            ...
            stack.push(
              A._Universe__lookupFunctionRti(t1, returnType, parameters)
            );
            return;
          case -4:
            stack.push(
              A._Universe__lookupRecordRti(t1, stack.pop(), requiredPositional)
            );
            return;
          default:
            throw A.wrapException(
      ...
      _isSubtype(universe, s, sEnv, t, tEnv) {
        ...
        t1 = sKind === 11;
        if (t1 && t === type$.Record) return true;
        if (t1 && tKind === 11)
      ...
      _isInterfaceSubtype(universe, s, sEnv, t, tEnv) {
        ...
        for (; sName !== tName; ) {
          ...
          for (i = 0; i < $length; ++i)
            supertypeArgs[i] = A._Universe_evalInEnvironment(
              universe,
              s,
              recipes[i]
            );
      ...
      MapBase_mapToString(m) {
        var result,
          t1 = {};
        if (A._isToStringVisiting(m)) return "{...}";
      ...
      NoSuchMethodError$_(
        ...
        return new A.NoSuchMethodError(
          receiver,
          memberName,
          positionalArguments,
          namedArguments,
      ...
      NoSuchMethodError_toString_closure:
        function NoSuchMethodError_toString_closure(t0, t1) {
          this._box_0 = t0;
          this.sb = t1;
        },
      ...
      allowInterop(f, $F) {
        ...
        else return $F._as(A._convertDartFunctionFast(f));
      },
      _someDartFunction() {
        A.printString("Hello from Dart!");
      },
      main() {
        self.functionName = A.allowInterop(
          A.main___someDartFunction$closure(),
          type$.void_Function
        );
      },
    },
  ...
  A.ConstantStringMap.prototype = {
    ...
    forEach$1(_, f) {
      ...
      keys = this._keys;
      for (
        t2 = keys.length, t3 = this._jsObject, t1 = t1._rest[1], i = 0;
        i < t2;
        ++i
      ) {
  ...
  A.JSInvocationMirror.prototype = {
    ...
    get$positionalArguments() {
      var t1,
        ...
        index,
        _this = this;
      if (_this.__js_helper$_kind === 1) return B.List_empty;
      t1 = _this._arguments;
      argumentCount =
        t1.length - _this._namedArgumentNames.length - _this._typeArgumentCount;
      if (argumentCount === 0) return B.List_empty;
      list = [];
      for (index = 0; index < argumentCount; ++index) {
        if (!(index < t1.length)) return A.ioore(t1, index);
        list.push(t1[index]);
      }
      list.fixed$length = Array;
      list.immutable$list = Array;
    ...
    get$namedArguments() {
      var t1,
        ...
        t4,
        _this = this;
      if (_this.__js_helper$_kind !== 0) return B.Map_empty;
      t1 = _this._namedArgumentNames;
      namedArgumentCount = t1.length;
      t2 = _this._arguments;
      namedArgumentsStartIndex =
        t2.length - namedArgumentCount - _this._typeArgumentCount;
      if (namedArgumentCount === 0) return B.Map_empty;
      map = new A.JsLinkedHashMap(type$.JsLinkedHashMap_Symbol_dynamic);
      for (i = 0; i < namedArgumentCount; ++i) {
        if (!(i < t1.length)) return A.ioore(t1, i);
        t3 = t1[i];
        t4 = namedArgumentsStartIndex + i;
        if (!(t4 >= 0 && t4 < t2.length)) return A.ioore(t2, t4);
  ...
  A.Closure.prototype = {
    toString$0(_) {
      ...
      return (
        "Closure '" + A.unminifyOrTag($name == null ? "unknown" : $name) + "'"
      );
    },
    $isFunction: 1,
    get$$call() {
  ...
  A.BoundClosure.prototype = {
    ...
    get$hashCode(_) {
      return (
        (A.objectHashCode(this._receiver) ^
          A.Primitives_objectHashCode(this.$_target)) >>>
        0
      );
    },
    toString$0(_) {
      return (
        ...
        this.$_name +
        "' of " +
        ("Instance of '" + A.Primitives_objectTypeName(this._receiver) + "'")
      );
    },
  };
  ...
  A.JsLinkedHashMap.prototype = {
    ...
    internalSet$2(key, value) {
      ...
      bucket = rest[hash];
      if (bucket == null) rest[hash] = [_this._newLinkedCell$2(key, value)];
      else {
    ...
    _newLinkedCell$2(key, value) {
      var _this = this,
        t1 = A._instanceType(_this),
        cell = new A.LinkedHashMapCell(
          t1._precomputed1._as(key),
          t1._rest[1]._as(value)
        );
      if (_this._first == null) _this._first = _this._last = cell;
      else _this._last = _this._last._next = cell;
  ...
  A.NoSuchMethodError.prototype = {
    toString$0(_) {
      ...
      _this._namedArguments.forEach$1(
        0,
        new A.NoSuchMethodError_toString_closure(_box_0, sb)
      );
      receiverText = A.Error_safeToString(_this._core$_receiver);
      actualParameters = sb.toString$0(0);
      return (
        "NoSuchMethodError: method not found: '" +
        _this._core$_memberName._name +
        "'\nReceiver: " +
        receiverText +
        "\nArguments: [" +
        actualParameters +
  ...
  (function installTearOffs() {
    ...
    _static_0(A, "main___someDartFunction$closure", "_someDartFunction", 6);
  })();
  (function inheritance() {
    ...
    _inherit(
      A.UnmodifiableMapView,
      A._UnmodifiableMapView_MapView__UnmodifiableMapMixin
    );
  ...
  (function constants() {
    ...
    B.List_empty0 = A._setArrayType(
      makeConstList([]),
      A.findType("JSArray<Symbol0>")
    );
    B.Map_empty = new A.ConstantStringMap(
      0,
      {},
      B.List_empty0,
      A.findType("ConstantStringMap<Symbol0,@>")
    );
  ...
  (function nativeSupport() {
    ...
    hunkHelpers.setOrUpdateInterceptorsByTag({
      ApplicationCacheErrorEvent: J.JavaScriptObject,
      DOMError: J.JavaScriptObject,
      ErrorEvent: J.JavaScriptObject,
      Event: J.JavaScriptObject,
      InputEvent: J.JavaScriptObject,
      SubmitEvent: J.JavaScriptObject,
      MediaError: J.JavaScriptObject,
      NavigatorUserMediaError: J.JavaScriptObject,
      OverconstrainedError: J.JavaScriptObject,
      PositionError: J.JavaScriptObject,
      GeolocationPositionError: J.JavaScriptObject,
      SensorErrorEvent: J.JavaScriptObject,
      SpeechRecognitionError: J.JavaScriptObject,
